...
class PasswordManager:
    ...
    def __init__(self):
        ...
        if enter_key == os.environ.get("master_key"):
            while True:
                print('''
                    Press 'Q' to quit
    ...
    def get_service_details(self):
        ...
        services_name_ls = conn.execute('SELECT name FROM DB')
        if len(services_name_ls) == 0:
